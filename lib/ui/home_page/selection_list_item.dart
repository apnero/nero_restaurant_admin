...
class SelectionListItem extends StatelessWidget {
  ...
  List<String> _mapToOneList(Map<String, List<String>> map) {
    List<String> newList = [];
  ...
  bool _isRecentOrder(){
    if(globals.recentOrders.containsKey(selection.uid)
        && globals.recentOrders[selection.uid].difference(DateTime.now()) < Duration(minutes: 2))
      return true;
  ...
  Widget build(BuildContext context) {
    return _isRecentOrder() == false ? Card(
        color: fromHomePage ? _nameToColor(selection.uid.toString()) : Theme.of(context).cardColor,
        ...
        child: new Container(
            ...
            child: new Column(children: <Widget>[
                  ...
                  children: <Widget>[
                    ...
                    new Container(
                        ...
                        child: new Row(children: <Widget>[
                          ...
                          new Column(
                            children: _mapToOneList(selection.choices)
                                .map((String string) {
                              return new Wrap(
                                children: [
                                  new Padding(
              ...
              new Row(children: <Widget>[
                ...
                new Text("  Sent " +
                    printDuration(DateTime.now().difference(selection.date),
